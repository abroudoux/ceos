...
export default function Navbar() {
    ...
    return (
        ...
        <nav className="backdrop-blur-sm bg-background absolute flex-row-center-center bottom-0 left-0 w-full h-auto border-t-[0.5px] border-grey-light">
            <ul className="flex-row-center-between">
                <NavLinks path="/" title="Accueil" icon={faHome} />
                <NavLinks path="/courses" title="Chercher" icon={faMagnifyingGlass} />
