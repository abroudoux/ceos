    ...
    return (
        <section className="page">
            ...
            <div className="w-full h-auto flex-row-center gap-2 mb-2">
                <div className="w-48 h-48 bg-[#361530] rounded-2xl relative hover:cursor-pointer hover:rounded-3xl transition-all">
                ...
                <div className="w-48 h-48 bg-[#172F22] rounded-2xl relative hover:cursor-pointer hover:rounded-3xl transition-all">
            ...
            <div className="w-full h-48 bg-[#0F3263] rounded-2xl relative hover:cursor-pointer hover:rounded-3xl transition-all">
